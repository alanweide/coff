 ...
 * <p>
 *
 * Typically these are properties that can be set from the command line (and
 * thus are NOT final). All final properties should be declared in Configuration
 */
public class Properties extends Options {
	...
	/**
	 * is the running VM fully booted? Set by VM.boot when the VM is fully
	 * booted.
	 */
	...
	/**
	 * The following is set on by -X:verboseBoot= command line argument. When
	 * true, it generates messages to the sysWrite stream summarizing progress
	 * during the execution of VM.boot
	 */
	public static int verboseBoot = 0;

	/**
	 * The following is set on by -verbose:class command line argument. When
	 * true, it generates messages to the sysWrite stream summarizing class
	 * loading activities
	 */
	public static boolean verboseClassLoading = false;

	/**
	 * The following is set on by -verbose:jni command line argument. When true,
	 * it generates messages to the sysWrite stream summarizing JNI activities
	 */
