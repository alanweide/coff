...
grep -h '^JNIEXPORT .* Java_' /home/alan/Developer/jikesrvm/components/classpath/97.2p13/classpath/include/*.h | \
...
find /home/alan/Developer/jikesrvm/components/classpath/97.2p13/classpath/native/jni -name \*.c | \
	xargs grep -h '^Java_' | \
...
find /home/alan/Developer/jikesrvm/components/classpath/97.2p13/classpath/native/jni -name \*.cpp | \
	xargs grep -h '^Java_' | \
        LC_ALL=C sed -e 's,^\(Java_[a-z_A-Z0-9]*\).*$,\1,' >> $TMPFILE2
find /home/alan/Developer/jikesrvm/components/classpath/97.2p13/classpath/native/jni -name \*.cpp | \
